...
print('<p align="center"><a href="https://www.hackerrank.com/"><img src="https://i0.wp.com/gradsingames.com/wp-content/uploads/2016/05/856771_668224053197841_1943699009_o.png" ></a></p>', file=readmeFile)
...
print(file=readmeFile)
print('[![GitHub last commit](https://img.shields.io/github/last-commit/AnTeater515/HackerRank-Coding_Solutions.svg)](https://github.com/AnTeater515/HackerRank-Coding_Solutions) ', file=readmeFile)
print('[![GitHub commit activity the past week, 4 weeks, year](https://img.shields.io/github/commit-activity/y/AnTeater515/HackerRank-Coding_Solutions.svg)](https://github.com/AnTeater515/HackerRank-Coding_Solutions)', file=readmeFile)
print('[![GitHub repo size in bytes](https://img.shields.io/github/repo-size/AnTeater515/HackerRank-Coding_Solutions.svg)](https://github.com/AnTeater515/HackerRank-Coding_Solutions) ', file=readmeFile)
print('[![GitHub stars](https://img.shields.io/github/stars/AnTeater515/HackerRank-Coding_Solutions.svg)](https://github.com/AnTeater515/HackerRank-Coding_Solutions)', file=readmeFile)
print(file=readmeFile)
        ...
        for file in sorted(files):
            if file.endswith(('.cpp', '.py', '.sql')):
                ...
                print('        - ' + "".join(file.split(".")[1:-1])[1:]
                      ...
                      + ')'
                      + ' | [Solution]'
                      + '(https://github.com/AnTeater515/HackerRank-Coding_Solutions/blob/master/'
